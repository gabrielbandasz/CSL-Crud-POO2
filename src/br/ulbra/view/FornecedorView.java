...
public class FornecedorView extends javax.swing.JFrame {
    ...
    private void initTableModel() {
        javax.swing.table.DefaultTableModel model = new javax.swing.table.DefaultTableModel(
                new Object[][]{},
                new String[]{"ID", "Nome Razao", "Nome Fantasia","E-mail", "Telefone"}) {
            @Override
    ...
    private void initComponents() {
        ...
        tbFornecedor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome Razão", "Nome Fantasia", "Telefone", "Email"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(BtnSalvarFor, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(BtnLimparFor, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(BtnEditarFor, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(BtnExcluirFor, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(BtnListarFor, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(TxtNomeRazaoFor)
                    .addComponent(TxtNomeFantasiaFor)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(BtnSalvarFor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnLimparFor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnEditarFor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnExcluirFor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnListarFor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void BtnEditarForActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarForActionPerformed
         try {
        int id = Integer.parseInt(TxtIdFor.getText().trim());
        String nomeRazao = TxtNomeRazaoFor.getText().trim();
        String nomeFantasia = TxtNomeFantasiaFor.getText().trim();
        String tel = TxtTelefoneFor.getText().trim();
        String email = TxtEmailFor.getText().trim();

        // Ordem correta: id, nome, nomeFantasia, telefone, email
        Fornecedor f = new Fornecedor(id, nomeRazao, nomeFantasia, tel, email);
...
int linha = tbFornecedor.getSelectedRow();
    if (linha != -1) {
        TxtIdFor.setText(tbFornecedor.getValueAt(linha, 0).toString());
        TxtNomeRazaoFor.setText(tbFornecedor.getValueAt(linha, 1).toString());
        TxtNomeFantasiaFor.setText(tbFornecedor.getValueAt(linha, 2).toString());
        TxtTelefoneFor.setText(tbFornecedor.getValueAt(linha, 3).toString());
        TxtEmailFor.setText(tbFornecedor.getValueAt(linha, 4).toString());
    }
